...
// TODO: Switch to https://github.com/steambap/png-to-ico since to-ico
// seems to give security issues. Low priority though.
...
module.exports = function (config, options = defaultOptions) {
  ...
  config.addAsyncShortcode("favicon", async (faviconFile) => {
